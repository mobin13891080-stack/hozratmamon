...
# لینک توسو باید همان ادرس https:// باشد (نه libsql://)
# چون ادرس libsql:// باعم می‌شود کتابخانه از پروتکل WebSocket استفاده کند که
# روی هاست رندر با خطای WSServerHandshakeError(400) قطع می‌شود.
# آدرس https:// باعم می‌شود کتابخانه از HTTP (پایدارتر و سازگارتر) استفاده کند.
...
# آدرس عمومی رندر (بعد از اولین دیپلوی به دست می‌آید)، متلا: https://myvpnbot.onrender.com
WEBHOOK_URL = os.environ.get("WEBHOOK_URL", "").rstrip("/")

# توکن امنیتی وبهوک - برای اینکه فقط تلگرام بتواند به ادرس وبهوک درخواست بفرستد
# اگر متفیر محیطی WEBHOOK_SECRET تنطیم نشود، از یک مقدار ثابت مشتق از توکن بات ساخته می‌شود
