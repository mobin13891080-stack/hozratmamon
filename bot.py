...
def build_application() -> Application:
    ...
    application.add_handler(CallbackQueryHandler(admin_core.admin_referral_test_link, pattern="^admin_referral_test_link$"))
    application.add_handler(CallbackQueryHandler(admin_core.admin_referral_test_disable, pattern="^admin_referral_test_disable$"))
    application.add_handler(CallbackQueryHandler(admin_core.admin_referral_test_reset, pattern="^admin_referral_test_reset$"))
