...
def build_application() -> Application:
    ...
    purchase_conv = ConversationHandler(
        ...
        states={
            ...
            handlers.USERNAME_INPUT: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, handlers.receive_desired_username),
                CallbackQueryHandler(handlers.username_random_callback, pattern="^username_random$"),
                CallbackQueryHandler(handlers.flow_cancel_callback, pattern="^flow_cancel$"),
            ],
    ...
    reject_reason_conv = ConversationHandler(
        ...
        states={
            handlers.REJECT_REASON_INPUT: [
                MessageHandler(filters.TEXT & ~filters.COMMAND, handlers.receive_reject_reason),
