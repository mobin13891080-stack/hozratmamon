...
def build_application() -> Application:
    ...
    application.add_handler(CallbackQueryHandler(admin_core.admin_trial_reset_confirm, pattern="^admin_trial_reset_confirm$"))
    application.add_handler(CallbackQueryHandler(admin_core.admin_trial_reset_do, pattern="^admin_trial_reset_do$"))
    application.add_handler(CallbackQueryHandler(admin_core.admin_trial_settings_show, pattern="^admin_trial_settings$"))
    ...
    application.add_handler(CallbackQueryHandler(admin_money.admin_revenue_reset_confirm, pattern="^admin_revenue_reset_confirm$"))
    application.add_handler(CallbackQueryHandler(admin_money.admin_revenue_reset_do, pattern="^admin_revenue_reset_do$"))
    application.add_handler(CallbackQueryHandler(admin_money.admin_finance_menu_close, pattern="^admin_finance_menu_close$"))

    # لاگ‌ها
    application.add_handler(CallbackQueryHandler(admin_stats_logs.logs_filter_callback, pattern=r"^logs_filter:\w+$"))
    application.add_handler(CallbackQueryHandler(admin_stats_logs.logs_reset_confirm_callback, pattern=r"^logs_reset_confirm:\w+$"))
    application.add_handler(CallbackQueryHandler(admin_stats_logs.logs_reset_do_callback, pattern=r"^logs_reset_do:\w+$"))
    application.add_handler(CallbackQueryHandler(admin_stats_logs.admin_logs_menu_callback, pattern="^admin_logs_menu$"))
