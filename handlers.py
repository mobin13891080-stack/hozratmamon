...
async def _process_wallet_payment(update, context):
    ...
    if referral_spend_enabled:
        ...
        if referral_needed > 0 and float(package_gb or 0) < spend_min_gb:
            await _reply(
                f"🔒 <b>این خرید با موجودی فعلی شما قابل انجام نیست.</b>\n\n"
                f"برای استفاده از بخشی از موجودی حاصل از دعوت دوستان، حداقل پلن مجاز "
                f"<b>{spend_min_gb:g} گیگ</b> است.\n\n"
                f"📦 حجم این پلن: <b>{float(package_gb or 0):g} گیگ</b>\n"
