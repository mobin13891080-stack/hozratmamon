...
ASYNC_SETTING_ACTIONS = {
    ...
    "admin_set_package_template": (
        "package_label_template",
        "✏️ <b>قالب دلخواه نمایش پلن‌ها را ارسال کنید.</b>\n"
...
async def get_package_label_template():
    return await database.get_setting("package_label_template", DEFAULT_PACKAGE_LABEL_TEMPLATE)
...
async def buy_category_callback(update, context):
    ...
    label_template = await get_package_label_template()
